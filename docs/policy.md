...
### 1.2 设备信息
为了向您发送推送通知，我们可能会收集您的设备标识符（如推送通知令牌）以及有关您的设备的基本信息，如设备型号、操作系统版本等。我们仅使用这些信息来确保推送通知能够正确送达您的设备。
...
我们承诺采取合理的技术和组织措施来保护您的数据安全。所有通过推送通知发送的消息和相关数据都会安全传输和存储。我们不会存储与您的设备推送通知令牌相关的任何个人敏感信息。
