...
var pageIntros: [PageIntro] = [
    .init(id: 1, introAssetImage: "Page 1",
          title: String(localized: "网络权限"),
          subTitle: String(localized: "用来获取提送密钥和接收通知.")),
    .init(id: 2, introAssetImage: "Page 2",
          title: String(localized: "通知权限"),
          subTitle: String(localized: "App 使用的最基本前提,用来接收通知")),
    .init(id: 3, introAssetImage: "Page 3",
          title: String(localized: "不需要任何的设置\n 打开即用"),
          subTitle: String(localized: "每个月需要打开一次App用来更新设备推送密钥."), displaysAction: true)
]
                        ...
                        Button {
                            if intro.id == 1{
                                Task.detached(priority: .userInitiated) {
                                    await AppManager.shared.fetchVoid(url: BaseConfig.defaultServer)
                                }
