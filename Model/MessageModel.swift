...
enum ChatPromptMode{
    ...
    static var summaryPrompt: ChatPrompt{
        ChatPrompt(
            timestamp: .now,
    ...
    static var abstractPrompt: ChatPrompt{
        ChatPrompt(
            timestamp: .now,
    ...
    static var translatePrompt:ChatPrompt{
        ChatPrompt(
           timestamp: .now,
    ...
    static var writingPrompt: ChatPrompt{
        ChatPrompt(
            timestamp: .now,
    ...
    static var codePrompt: ChatPrompt {
        ChatPrompt(
            timestamp: .now,
