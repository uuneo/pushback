...
class FileUtils {
    ...
    static func getExtensionFromMIME(_ mimeType: String) -> String {
        switch mimeType {
        case "audio/pcm":
            return "pcm"
        case "audio/basic":
    ...
    static func FileName(text:String) throws -> URL{
        ...
        return  group.appendingPathComponent(fileName, conformingTo: .audio)
    }
...
extension Defaults.Keys {
    static let ttsConfig = Key<TTSConfig>("SpeakTTSConfig", TTSConfig.default)
    static let voiceList = Key<[MicrosoftVoice]>("SpeakVoiceList", [])
...
extension TTSConfig: Defaults.Serializable{ }
extension SSMLConfig: Defaults.Serializable{}
extension MicrosoftVoice: Defaults.Serializable{}
