...
struct SelectMessageView:View {
    ...
    @State private var loading:ChatPromptMode = .code
    
    @State private var messageShowMode:ChatPromptMode = .code
    ...
    var body: some View {
                                ...
                                Section {
                                    Button {
                                        ...
                                        Label("保存图片", systemImage: "square.and.arrow.down.on.square")
                                            ...
                                            .foregroundStyle(Color.accentColor, .green)
                                    }
                                }
                            }
                ...
                VStack{
                    ...
                    if messageShowMode == .abstract{
                        VStack{
                            ...
                            AbstractMessageView(message: message, scaleFactor: scaleFactor, abstractResult: $abstractResult)
                        }
                    ...
                    if messageShowMode == .translate{
                        ...
                        TranslateMesssageView(message: message, scaleFactor: scaleFactor,translateResult: $translateResult)
        ...
        .safeAreaInset(edge: .bottom, alignment: .leading){
            HStack{
                ...
                Button{
                    self.messageShowMode = (self.messageShowMode == .translate) ?  .code : .translate
                    Haptic.impact()
                ...
                Button{
                    self.messageShowMode = (self.messageShowMode == .abstract) ?  .code : .abstract
                    Haptic.impact()
                }label: {
